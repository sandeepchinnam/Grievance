      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li>
              <form action="login_.html">
              <input style="background-color: #27A878; border: none; color: white; border-radius: 5px; padding: 5px;"
                  type="submit"
				  value = " Login/SignUp "
                /></form>
            </li>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab01" role="tabpanel">
                ...
                <div class="tab-pane-item">
                  ...
                  <p>
                    ...
                    sodales ac turpis. Morbi ac felis sagittis, faucibus mauris
                    vitae, placerat mauris.
                  </p>
                </div>
              </div>
              ...
              <div class="tab-pane" id="tab02" role="tabpanel">
                <div class="tab-pane-item">
                  ...
                  <p>
                    Nam maximus elit a metus luctus, a faucibus magna mattis. Ut
                    malesuada viverra iaculis. Nunc euismod sit amet neque a
                    tincidunt.
                  </p>
                </div>
                <div class="tab-pane-item">
                  <h2>User Friendly</h2>
                  <p>
                    Maecenas maximus velit lorem, quis pharetra turpis fringilla
                    id. Vestibulum tempor facilisis efficitur. Sed nec nisi sit
                    amet nibh pellentesque elementum.
                  </p>
                </div>
                <div class="tab-pane-item">
                  <h2>HTML5 & CSS3</h2>
                  <p>
                    In viverra ipsum ornare sapien rhoncus ullamcorper. Vivamus
                    vitae risus ac mi vehicula sagittis. Nulla dictum magna sit
                    amet pharetra aliquam.
                  </p>
                </div>
              </div>
              ...
              <div class="tab-pane" id="tab03" role="tabpanel">
                ...
                <div class="tab-pane-item">
                  ...
                  <p>
                    Quisque ullamcorper sem quis sapien cursus efficitur. Sed id
                    sodales ipsum. Morbi eleifend tempus erat sit amet vehicula.
                    Nulla at posuere tellus, non mattis erat. Nulla id massa
                    gravida.
                  </p>
                </div>
              </div>
